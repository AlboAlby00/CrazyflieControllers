...
PositionPID::PositionPID() : 
    Node("attitude_pid_controller"), _input_yaw(0.0), _target_x(0.0), _target_y(0.0), _target_z(0.0),
        _pid_x(0.01, 0, 0.04), _pid_y(0.01, 0, 0.04), _pid_z(8, 1 , 10)
{
...
void PositionPID::_sendCommandAttitude()
{
    ...
    double pid_x = _pid_x.getCommand(_x, _target_x, dt, true, 0.1);
    double pid_y = _pid_y.getCommand(_y, _target_y, dt, true, 0.1);
    double pid_z = _pid_z.getCommand(_z, _target_z, dt, true, 0.1);
